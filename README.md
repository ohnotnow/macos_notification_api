...
A simple FastAPI server that displays macOS notifications. Useful for receiving alerts from remote machines (e.g., a Raspberry Pi notifying you when a long-running task completes).
